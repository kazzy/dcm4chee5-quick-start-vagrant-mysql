...
<server xmlns="urn:jboss:domain:2.2">
    ...
    <system-properties>
       ...
       <property name="org.dcm4che.conf.filename" value="/opt/wildfly/standalone/configuration/dcm4chee-arc/sample-config.json" />
    </system-properties>
        ...
        <subsystem xmlns="urn:jboss:domain:datasources:2.0">
            <datasources>
                <datasource jndi-name="java:jboss/datasources/ExampleDS" pool-name="ExampleDS" enabled="true" use-java-context="true">
                 ...
                 <datasource jndi-name="java:/PacsDS" pool-name="PacsDS" enabled="true">
                     <connection-url>jdbc:postgresql://localhost:5432/dcm4chee</connection-url>
                     <driver>postgresql</driver>
                     <security>
                         <user-name>dcm4chee</user-name>
                         <password>dcm4chee</password>
                     </security>
                 </datasource>
                <drivers>
        ...
        <subsystem xmlns="urn:jboss:domain:messaging:2.0">
            <hornetq-server>
                ...
                <jms-destinations>
                    ...
                    <jms-queue name="ianscu">
                        <entry name="queue/ianscu"/>
                    </jms-queue>
                    <jms-queue name="mppsscu">
                        <entry name="queue/mppsscu"/>
                    </jms-queue>
                    <jms-queue name="stgcmtscp">
                        <entry name="queue/stgcmtscp"/>
                    </jms-queue>
                    <jms-queue name="delete">
                        <entry name="queue/delete"/>
                    </jms-queue>
                    <jms-queue name="archiver">
                        <entry name="queue/archiver"/>
                    </jms-queue>
                    <jms-queue name="storescu">
                        <entry name="queue/storescu"/>
                    </jms-queue>
                </jms-destinations>
            </hornetq-server>
        </subsystem>
